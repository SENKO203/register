...
مهمتك: اكتشف كل النصوص الموجودة في الصورة (كورية، يابانية، صينية، إنجليزية — أي نص داخل فقاعات الكلام أو خارجها) وترجمها إلى العربية.

لكل نص:
- x, y: موضع الزاوية العلوية اليسرى كنسبة مئوية (0-100) من أبعاد الصورة
- w, h: العرض والارتفاع كنسبة مئوية (0-100) — كن دقيقاً في تحديد حدود الفقاعة
...
• مؤثرات صوتية (أصوات طعام، ضربات، انفجارات) → ترجم المعنى مع الحفاظ على الإيقاع
...
{"blocks":[{"x":10,"y":5,"w":30,"h":8,"original":"النص الأصلي","translated":"الترجمة العربية"}]}
